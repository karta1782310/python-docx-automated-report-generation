...
from ExcelToWord_Final import ExcelToWord
...
class Ui_ExcelToWord(object):
    def setupUi(self, ExcelToWord):
        ...
        self.Company = QtWidgets.QLabel(ExcelToWord)
        self.Company.setObjectName("Company")
        self.horizontalLayout_3.addWidget(self.Company)
        self.Company_in = QtWidgets.QLineEdit(ExcelToWord)
        self.Company_in.setMinimumSize(QtCore.QSize(80, 16777215))
        self.Company_in.setObjectName("Company_in")
        self.horizontalLayout_3.addWidget(self.Company_in)
        ...
        self.Year_in.setMinimumSize(QtCore.QSize(60, 16777215))
        ...
        self.Month_in.setMinimumSize(QtCore.QSize(40, 16777215))
        ...
        self.Day_in.setMinimumSize(QtCore.QSize(40, 16777215))
        ...
        self.IP_in.setText("")
        self.IP_in.setMinimumSize(QtCore.QSize(120, 16777215))
        ...
        self.Info_btn.setMaximumSize(QtCore.QSize(100, 16777215))
    ...
    def retranslateUi(self, ExcelToWord):
        ...
        ExcelToWord.setWindowTitle(_translate(
            "ExcelToWord", "Excel To Word v.1.0.1"))
        ...
        self.Company.setText(_translate("ExcelToWord", "Company"))
        ...
        self.IP.setText(_translate("ExcelToWord", "IP (option)"))
...
3. 風險評估：highRiskIpList\n4. 高風險 Top10：highRiskTop10\n5. 風險項目描述：cveDescribe高/中/低\n\n\n'
        normal_text = '文字類： 於需要位置填入以下標籤\n\n1. 公司名稱：OOOOO (英文)\n2. 年：YYYY\n3. 月：MMMM\n4. 日：DDDD\n\
5. 總掃描主機個數：totalIpCnt\n6. 總弱點個數：weaknessCount\n7. 高風險個數：highRiskWeaknessCount\n\
8. 中風險個數：middleRiskWeaknessCount\n9. 低風險個數：lowRiskWeaknessCount\n10. 高風險主機個數：highRiskIpCnt\n\
11. 參考 Excel 表：referExcel\n12. 風險項目個數：cveCnt高/中/低\n\n'

        dialog = QMessageBox(self)
        dialog.setInformativeText(title_text+table_text+normal_text)
    ...
    def input_data(self):
        ...
        ips = []
        save = self.Save_in.text() + "/" + self.Savefile_in.text() + ".docx"

        if not excel or not sheet or not word or not date or not save or not company:
            ...
            self.textEdit.append("Company : %s" % company)
            ...
            ExcelToWord(excel, sheet, word, company, date, ips, save)
            QApplication.processEvents()
            time.sleep(1)
